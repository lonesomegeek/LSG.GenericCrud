...
namespace LSG.GenericCrud.Tests.Controllers
{
    ...
    public class CrudAsyncControllerTestsWithoutService
    {
        private readonly IList<TestEntity> _entities;
        private readonly TestEntity _entity;

        public CrudAsyncControllerTestsWithoutService()
        {
        ...
        public async Task GetAll_ReturnsOk()
        {
            ...
            var controller = new CrudAsyncControllerWithoutService<TestEntity>(dalMock.Object);
