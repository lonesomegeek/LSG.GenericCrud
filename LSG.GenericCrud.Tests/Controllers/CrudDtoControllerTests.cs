...
namespace LSG.GenericCrud.Tests.Controllers
{
    ...
    public class CrudDtoControllerTests
    {
        ...
        {
            var dalMock = new Mock<Crud<TestDto>>();
            dalMock.Setup(_ => _.GetAll()).Returns(_dtos);
            var controller = new CrudController<TestDto>(dalMock.Object);
